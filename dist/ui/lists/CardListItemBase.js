...
var CardListItemBase = function (props) {
    var imageFloat = props.imageFloat, highlightPrimary = props.highlightPrimary, imageUrl = props.imageUrl, imageAltText = props.imageAltText, primaryText = props.primaryText, secondaryText = props.secondaryText, overlineText = props.overlineText, underlineText = props.underlineText, linkClassProps = props.linkClassProps, rest = __rest(props, ["imageFloat", "highlightPrimary", "imageUrl", "imageAltText", "primaryText", "secondaryText", "overlineText", "underlineText", "linkClassProps"]);
    ...
    if (underlineText) {
        underlineNode = react_1.default.createElement(Overline_1.default, null, underlineText);
    }
